...
$page['name'] = 'Paramètre utilisateur';
...
if (isset($_POST['updateSettingsBtn'])) {
    ...
    if ($user['email'] === $updateEmail) {
        ...
        if (empty($updatePassword)) {
            ...
            logAction('Updated User Settings', $user['username']);
...
<body>
    ...
    if (isset($_GET['error']) && strip_tags($_GET['error']) === 'no-updates') {
        throwError('Nous n\'avons pas détecté de modification !');
    } elseif (isset($_GET['success']) && strip_tags($_GET['success'])) {
        clientNotify('success', 'Enregistrer');
    }
    ?>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="bg-picture card-box">
                        <h4 class="m-t-0 header-title">Paramètres</h4>
                            ...
                            <div class="profile-info-detail">
                                <form method="POST">
                                    ...
                                    <div class="form-group text-center">
                                        <div class="col-12">
                                            <button class="btn btn-success btn-bordred btn-block waves-effect waves-light" type="submit" name="updateSettingsBtn">Enregistrer</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
