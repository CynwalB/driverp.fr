    ...
    $(document).ready(function() {
        $('#createCharacter').ajaxForm(function(error) {
            ...
            if (error['msg'] === "") {
                ...
                toastr.success('Personnage créé', 'Système :', {
                    timeOut: 10000
                });
            } else {
        ...
        $('#new911call').ajaxForm(function(error) {
            ...
            if (error['msg'] === "") {
                ...
                toastr.success('Appel 911 Créé', 'Système :', {
                    timeOut: 10000
                });
            } else {
                toastr.error(error['msg'], 'Système :', {
        ...
        $('#createVehicle').ajaxForm(function(error) {
            ...
            if (error['msg'] === "") {
                ...
                toastr.success('Véhicule ajouté au système', 'Système :', {
                    timeOut: 10000
                });
            } else {
                toastr.error(error['msg'], 'Système :', {
        ...
        $('#createFirearm').ajaxForm(function(error) {
            ...
            if (error['msg'] === "") {
                ...
                toastr.success('Arme à feu ajoutée au système', 'Système :', {
                    timeOut: 10000
                });
            } else {
                toastr.error(error['msg'], 'Système :', {
        ...
        $('#createWarrant').ajaxForm(function(error) {
            ...
            if (error['msg'] === "") {
                ...
                toastr.success('Avis de recherche créé.', 'Système :', {
                    timeOut: 10000
                });
            } else {
                toastr.error(error['msg'], 'Système :', {
...
<body>
    <?php
        if (isset($_GET['error']) && strip_tags($_GET['error']) === 'character-not-found') {
            clientNotify('error', 'Nous n\'avons pas pu trouver ce personnage.');
        } elseif (isset($_GET['error']) && strip_tags($_GET['error']) === 'character-owner') {
            clientNotify('error', 'Pas de permission.');
        } elseif (isset($_GET['error']) && strip_tags($_GET['error']) === 'character-session') {
            clientNotify('error', 'Erreur de session. Sélectionnez à nouveau le personnage.');
        } elseif (isset($_GET['error']) && strip_tags($_GET['error']) === 'character-deleted') {
            clientNotify('error', 'Personnage supprimé !');
        }
        ?>
                ...
                <div class="col">
                    <div class="card-box">
                        <select class="form-control" id="listCharacters" onchange="location = this.value;">
                            <option selected="true" disabled="disabled">Chargement des personnages...</option>
                        </select>
                    </div>
                </div>
                <div class="col">
                    <div class="card-box">
                        <h4 class="header-title mt-0 m-b-30">Créateur de personnage</h4>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card-box">
                        ...
                        <div class="dropdown pull-right">
                            <button class="btn btn-success btn-sm w-40" data-toggle="modal" data-target="#newSelfWarrantModal">Add New Warrant (Self)</button>
                        </div>
                        <!-- New Warrant Model -->
