...
<body>
    <div class="container">
        <a href="https://driverp.fr/" title="Page d'accueil"><img width="30%" src="../../image/Logo.png"></a>
        <div class="form-outer">
            <!-- <header>NOM SERVEUR</header> -->
            <h2 style="color:red">Vous avez déjà fait une demande !</h2>
            <h4 style="color:white;">Si ce n'est pas le cas, veuillez contactez un membre du staff.</h4><br>
