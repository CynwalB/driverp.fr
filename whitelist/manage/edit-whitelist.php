...
while ($userInfo = mysqli_fetch_array($result)) {
    ...
    if ($userInfo['validation'] == '1') {
        $stats = '<font color=green>Whitelist Active</font>';
    } else if ($userInfo['validation'] == '2') {
        $stats = '<font color=red>Whitelist Refusée</font>';
    } else {
    ...
    <!-- <div class="background"> -->
        <div class="container">
            ...
            <div class="form-outer">
                <header style="color:white;">Visualisation du formulaire</header>
                ...
                <form class="form" action="#" method="POST">
                    ...
                    <div class="page">
                        ...
                        <div class="field">
                            ...
                            <input type="text" required placeholder="<?php echo $heuresteam; ?> h" disabled />
                        </div>
                    ...
                    <div class="page">
                        ...
                        <div class="field">
                            ...
                            <textarea type="textarea" id="background" rows="5" cols="33" disabled><?php echo $background; ?></textarea>
                        </div><br><br>
                        <div class="field">
                            <div class="label">Confirmer la lecture du <a style="color: #ea0171;" href="../../wiki">Règlement</a></div>
                    ...
                    <div class="page">
                        ...
                        <h2 style="color:white;">Status du formulaire: <?php echo $stats; ?></h2>
                        <div class="field btns">
                            <button class="prev-6 prev">🠔 Revenir </button>
                        </div>
                    </div>
                </form>
            </div>
