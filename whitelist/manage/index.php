...
<body>
  <!-- <div class="background"> -->
    <div class="container"><br>
      <center><img src="../../image/Logo.png" width="20%"></center>
      <div class="row py-5">
        <div class="col-12">
              ...
              <tbody>
                ...
                while ($resultatInfos = mysqli_fetch_array($result)) {
                  ...
                  if ($resultatInfos['validation'] == '1') {
                    $stats = '<div class="badge badge-success badge-success-alt">Whitelist Active</div>';
                  } else if ($resultatInfos['validation'] == '2') {
                    $stats = '<div class="badge badge-danger badge-danger-alt">Whitelist Refusée</div>';
                  } else {
      ...
      <a class="deco" href="../connexion/deconnexion.php">Se déconnecter</a>
    </div>
  <!-- </div> -->
  <!-- partial -->
